...
import com.pm.shopping.model.service.ShoppingQnaService;
...
public class ShopQnaController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount = new ShoppingQnaService().selectListCount(); 
		...
		ArrayList<ShoppingQna> list = new ShoppingQnaService().selectList(pi);
