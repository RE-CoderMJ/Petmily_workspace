			...
			<div class="middle" align="left" style="width: 50%;">
				...
				<div></div>
					...
					<div class="category-area" align="left">
						...
						<button type="button" class="btn btn-light btn-sm">건강관리</button>
						<button type="button" class="btn btn-light btn-sm">모래</button>
						<button type="button" class="btn btn-light btn-sm">화장실/위생</button>
						<button type="button" class="btn btn-light btn-sm">장난감</button>
						<button type="button" class="btn btn-light btn-sm">스크래쳐</button>
					</div>
					<script>
				          $(function(){
