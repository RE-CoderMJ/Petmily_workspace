    ...
    <div id="outer">
       ...
       <div class="content-area" align="center">
          <div id="top">
           ...
           <form action="<%=contextPath%>/update.ask?ano=<%=a.getAskNo() %>" method="post" enctype="multipart/form-data">
              ...
              <div id="photo-area">
               ...
               <div id="input-area">
                   ...
                   <div id="title-area">
                       ...
                       <span class="required">*</span>
                       <input type="text" name="title"  placeholder="제목을 입력해주세요" value="<%=a.getAskTitle() %>" required>
                   </div>
                   <div id="text-area">
                       <textarea name="content" placeholder="내용을 입력해주세요"><%=a.getAskContent() %></textarea>
                   </div>
               </div>    
